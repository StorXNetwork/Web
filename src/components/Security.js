...
class Security extends React.Component {
                  ...
                  <div className="row justify-content-center align-items-center">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12 align-self-center">
                      <div className="sign-user_card inside">
                        <h5 className="mb-4 text-center">Two-Factor Authentication</h5>
                        <p>Two-Factor Authentication provides an extra layer of security for your StorX account by requiring a second step of verification when you sign in. In addition to your password, you’ll also need a code generated by Authy, Google Authenticator or a similar on your phone. Follow the steps below to enable 2FA on your account.</p>
                        <div className="security-button-block" id="buttons" style={{ display: this.state.showButtons ? 'block' : 'none' }}>
  ...
  boxStep1() {
    return <div className="steps">
      <div className="mb-4">Download Authy, Google Authenticator or a similar app on your device.</div>
      <div>
  ...
  boxStep2() {
    return <div className="steps">
      <div className="mb-3">Use Authy, Google Authentication or a similar app to scan the QR Code below</div>
      <div className="mb-4">
  ...
  boxStep3() {
    return <div className="steps">
      <div className="mb-4">Your backup key is below. You will need this incase you lose your device. Keep an offline backup of your key. Keep it safe and secure.</div>
