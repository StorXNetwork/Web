    ...
    return (
        ...
        <>
            ...
            <section className="banner ad-banner-1">
                <div className="container">
                    <div className="content-wrapper">
                        <h1 className="landing-h1">StorX — Store Your Personal Data On The <br/>
                            Most Secure Cloud Storage Platform <br/>
                            That CAN'T Monetize Your Data </h1>
                        <p className="white">Most traditional cloud storage solutions say they
                            don't sell your data, yet collect and process <br/> them. We at StorX
                            believe your data should be truly private, period. <br/>
                            StorX's blockchain powered decentralized cloud storage platform
                            is the change you've always <br/> wanted for your personal data. </p>
                        <a href="#contact-us"
            ...
            <section className="ads-pros-cons">
                <div className="container">
                    <div className="pros-cons-wrapper">
                        ...
                        <li>
                            <img src={thumbdown} className="thumb" alt="icon"/>
                            <p>Costs pile up if you want better data security and encryption. </p>
                        </li>
                        </ul>
                        ...
                        <li>
                            <img src={thumbup} className="thumb" alt="icon"/>
                            <p>Decentralized architecture means your data is never available to
                                anyone, except you— be it third parties or to us. </p>
                        </li>
                        <li>
                            <img src={thumbup} className="thumb" alt="icon"/>
                            <p>Even in the event of a breach, a threat actor gets access
                                access to only an unrecognizable encrypted fragment of your data.  </p>
                        </li>
                        <li>
                            <img src={thumbup} className="thumb" alt="icon"/>
                        ...
                        <li>
                            <img src={thumbup} className="thumb" alt="icon"/>
                            <p>Everyone gets the most robust security with no hidden costs.</p>
                        </li>
                        </ul>
                    </div>
                ...
                <div className="container">
                    ...
                    <div className="join-community-wrapper">
                        ...
                        <div className="join-community-card">
                            ...
                            <p className="p flex">Storage Providers <img src="./images/icons/alert-icon.svg" alt="icon"  data-toggle="tooltip" title="StorX Network uses advanced encryption and data fragmentation to secure your data, which is stored on a vast network of independent nodes spread across the globe. "/></p>
                        </div>
                        <div className="join-community-card">
                            <h3 className="landing-h2">32,418,520.38 +</h3>
                            <p className="p flex">SRX Staked <img src="./images/icons/alert-icon.svg" alt="icon"  data-toggle="tooltip" title="Node operators earn rewards in the form of $SRX, a token developed by StorX."/></p>
                        </div>
                    </div>
                </div>
            </section>
            <section className="storx-use">
                <div className="container">
                    <h2 className="landing-h2">StorX Feels Like cloud storage You're are used to, <br/>
                        Just <span>MILES AHEAD</span> in security and privacy. </h2>
